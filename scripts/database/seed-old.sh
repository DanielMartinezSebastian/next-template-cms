...
if [ ! -f "scripts/database/seed.ts" ]; then
    ...
    docker-compose -f docker-compose.dev.yml exec -T postgres-dev psql -U dev_user -d nextjs_template_dev <<-EOSQL
        ...
        INSERT INTO translations (id, key, value, "localeId", "namespaceId", "isActive", "createdAt", "updatedAt", "createdAt", "updatedAt") VALUES 
        -- Common translations
        ('trans_en_common_1', 'app.name', 'Next.js Template', 'locale_en', 'ns_common', true, NOW(), NOW()),
        ('trans_en_common_2', 'app.description', 'A modern Next.js template with CMS capabilities', 'locale_en', 'ns_common', true, NOW(), NOW()),
        ...
        INSERT INTO translations (id, key, value, "localeId", "namespaceId", "isActive", "createdAt", "updatedAt") VALUES 
        -- Common translations
        ...
        INSERT INTO pages (id, slug, "isActive", template, "createdAt", "updatedAt") VALUES 
        ...
        INSERT INTO page_contents (id, "pageId", "localeId", title, description, "metaTitle", "metaDescription", keywords, content, "isPublished", "createdAt", "updatedAt") VALUES 
        ...
        INSERT INTO components (id, name, type, category, description, "configSchema", "defaultConfig", "isActive", "createdAt", "updatedAt") VALUES 
        ...
        INSERT INTO system_config (id, key, value, description, category, "createdAt", "updatedAt") VALUES 
